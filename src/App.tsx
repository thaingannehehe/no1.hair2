...
function App() {
  ...
  return (
    <div className="relative min-h-screen bg-[#F6F6F5] text-[#1C1C1C]">
      <Nav heroRef={heroRef} visible={heroContentVisible} />

      <main className="relative z-[1] bg-[#F6F6F5]">
        <Hero ref={heroRef} visible={heroContentVisible} />
        {belowFoldReady ? (
          <>
            <Suspense fallback={<div className="min-h-[50vh] bg-[#F6F6F5]" />}>
              <ImageGallery />
            </Suspense>
            <Suspense fallback={<div className="min-h-[20vh] bg-[#F6F6F5]" />}>
              <Stats />
            </Suspense>
            <Suspense fallback={<div className="min-h-[50vh] bg-[#F6F6F5]" />}>
              <VideoShowcase />
          ...
          <div className="min-h-[50vh] bg-[#F6F6F5]" />
        )}
      </main>
