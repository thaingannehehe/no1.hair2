...
function FaqItem({
  ...
  return (
    <div className="border-b border-[#1C1C1C]/10">
      ...
      >
        <span
          className="text-[19px] leading-[1.4] tracking-[-0.01em] text-[#1C1C1C] md:text-[22px]"
          style={{ fontFamily: "'Newsreader', serif", fontWeight: 400 }}
        >
          {faq.q}
        </span>
        <span className="shrink-0 text-[#2A2A2A]">
      ...
      >
        <div className="overflow-hidden">
          <p
            className="pb-7 pr-10 text-[15px] leading-[1.8] text-[#767676] md:pb-8 md:text-[16px]"
