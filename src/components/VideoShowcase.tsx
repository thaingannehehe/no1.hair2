...
export default function VideoShowcase() {
  ...
  return (
    <section
      ...
      id="video"
      className="bg-[#F6F6F5] py-20 md:py-28"
    >
      <div className="container mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div ref={headerRef} className="mb-12 flex flex-col gap-8 md:mb-16 md:flex-row md:items-end md:justify-between">
          <div className="flex flex-col gap-3">
            <span className="text-[10px] font-medium uppercase tracking-[0.38em] text-[#767676]">
              Reel
            </span>
            <h2 className="max-w-[760px] text-[clamp(1.75rem,3.5vw,3.5rem)] font-semibold leading-[0.98] tracking-[-0.055em] text-[#1C1C1C]">
              Trải nghiệm của khách hàng
            </h2>
            <p className="max-w-[480px] pb-1 text-[15px] leading-[1.75] tracking-[-0.01em] text-[#767676]">
              Thử những kiểu tóc được yêu thích tại No.1 Hair Room, từ cắt, uốn, nhuộm đến tạo kiểu với giá hợp lý cho khách hàng tại Thủ Dầu Một.
            </p>
          </div>
        ...
        <div className="mt-20 flex justify-center">
          <a
            ...
            className="bg-[#2A2A2A] px-10 py-4 text-[12px] uppercase tracking-[0.15em] text-white transition-colors duration-300 hover:bg-[#000000] active:scale-95"
