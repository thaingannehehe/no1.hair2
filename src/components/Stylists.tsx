        ...
        >
          {STYLISTS.map((stylist) => (
            <article key={stylist.name} className="group">
              <div className="aspect-square overflow-hidden rounded-xl bg-[#E4E4E4]">
                <img
                  src={stylist.img}
                  alt={stylist.name}
                  loading="lazy"
              ...
              <p
                className="mt-5 text-[11px] uppercase tracking-[0.2em] text-[#2A2A2A] md:text-[12px]"
                style={{ fontFamily: "'JetBrains Mono', monospace" }}
              >
                {stylist.role}
              </p>
              <h3
                className="mt-2 text-[32px] leading-[1.05] tracking-tight text-[#1C1C1C] md:text-[38px]"
