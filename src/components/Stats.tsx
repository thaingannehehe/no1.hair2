...
const STATS: Stat[] = [
  { value: 4.9, decimals: 1, suffix: '★', label: 'Đánh giá từ khách hàng' },
  { value: 805, suffix: '+', label: 'Lượt đánh giá' },
...
export default function Stats() {
  ...
  return (
    <section
      ...
      className="bg-[#F6F6F5] px-6 pb-16 pt-16 md:px-12 md:pb-24 md:pt-24"
    >
      <div className="mx-auto max-w-[1200px]">
        <div className="grid grid-cols-2 gap-10 border-t border-[#1C1C1C]/10 pt-12 md:grid-cols-3 md:items-end">
          {STATS.map((stat, index) => (
            <div key={stat.label} className={index === 2 ? 'col-span-2 md:col-span-1' : ''}>
              <div
                className="font-display text-5xl font-semibold leading-none tracking-tight text-[#1C1C1C] md:text-6xl"
              ...
              <div className="mt-3 text-[10px] uppercase tracking-[0.24em] text-[#1C1C1C]/50 md:text-[11px]">
                {stat.label}
              </div>
            </div>
          ))}
