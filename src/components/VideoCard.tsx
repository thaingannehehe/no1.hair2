...
export default function VideoCard({ video }: VideoCardProps) {
  ...
  return (
    <div
      ref={containerRef}
      className="group relative aspect-[9/16] w-[72vw] shrink-0 snap-start overflow-hidden rounded-none bg-[#E4E4E4] shadow-[0_2px_12px_rgba(52,40,45,0.06)] transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-[0_12px_32px_rgba(52,40,45,0.12)] sm:w-[300px] lg:w-[320px]"
    >
      {mounted ? (
        <video
          src={video.src}
